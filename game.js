...
function showQuestComplete(quest) {
  ...
  popup.innerHTML = `<span style="font-size:10px;color:#FFD700;font-weight:900;">✅ ${quest.title}</span> <span style="font-size:10px;color:#fff;">🍔+${quest.rewardCoins} ⭐+${quest.rewardExp}</span>`;
  document.body.appendChild(popup);
  setTimeout(() => {
