...
function checkWishFragment() {
  if (Math.random() < 0.008) {
    ...
    addToBag('🧩', '소원의 조각', 'wish', 1, `100개 모으면 소원 완성! (현재: ${wishFragments}개)`);
    showWishFragment();
  }
}
