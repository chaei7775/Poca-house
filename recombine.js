...
const RC_TABLE = {
  'N_N':     { upgrade: 70,   same: 28.97, rareHidden: 1.03, epicHidden: 0,    coin: 500,    stones: { normal: 1, epic: 0 } },
  'N_R':     { upgrade: 50,   same: 48.95, rareHidden: 1.05, epicHidden: 0,    coin: 500,    stones: { normal: 1, epic: 0 } },
  'R_R':     { upgrade: 45,   same: 53.95, rareHidden: 1.05, epicHidden: 0,    coin: 2500,   stones: { normal: 2, epic: 0 } },
  'R_SR':    { upgrade: 35,   same: 63.9,  rareHidden: 1.1,  epicHidden: 0,    coin: 2500,   stones: { normal: 2, epic: 0 } },
  'SR_SR':   { upgrade: 25,   same: 73.9,  rareHidden: 1.1,  epicHidden: 0,    coin: 10000,  stones: { normal: 3, epic: 0 } },
  'SR_SSR':  { upgrade: 18,   same: 79.7,  rareHidden: 1.25, epicHidden: 1.05, coin: 10000,  stones: { normal: 3, epic: 0 } },
  'SSR_SSR': { upgrade: 8,    same: 89.7,  rareHidden: 1.25, epicHidden: 1.05, coin: 35000,  stones: { normal: 3, epic: 1 } },
  'SSR_UR':  { upgrade: 5,    same: 92.5,  rareHidden: 1.4,  epicHidden: 1.1,  coin: 35000,  stones: { normal: 3, epic: 1 } },
